...
data = {
    'AsOfDate': generate_random_dates('2023-01-01', '2023-01-31', num_rows), # Random dates in 2023
...
# Save to CSV
df.to_csv('random_data_current_month.csv', index=False)

print("Random data with dates saved as 'random_data_current_month.csv'")